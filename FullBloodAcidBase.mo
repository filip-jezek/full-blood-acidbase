...
*/
    ...
    protected
      ...
      Real albuminPks[:]={8.5,3.9,11.7,12.5,5.8,6.15,7.51,7.685,7.86,10.3,7.12
           - NB,7.22 - NB,7.1 - NB,7.49 - NB,7.01 - NB,7.31,6.75,6.36,4.85,5.76,
          6.17,6.73,5.82,5.1,6.7,6.2,8,3.1};
...
<pre><font style=\"color: #006400; \">Filip Jezek, 2016</font></pre>
  ...
  package SAnomogram_formalization
    ...
    public
      ...
      Real pH=(a[1]*a[10] + a[2]*Y + (a[3]*a[10] + a[4]*Y)*log10(pCO2))/(a[5]*a[
          10] + a[6]*Y);
    ...
    public
      ...
      Real pH(start=7.4) = (log10(pCO2) - log10(pCO2BB))*(pHBB - pHBE)/(log10(
        pCO2BB) - log10(pCO2BE)) + pHBB;
    equation
    ...
    model SAVanSlyke
      ...
      Real ctHb=Hb*4 "SA is considering the monomer of hemoglobin tetramer";
  ...
  package Full_Blood
    ...
    model CombinedModel
      ...
      replaceable SAnomogram_formalization.SAoriginal fullErythrocyte(
        Hct=1,
        BEox=BEe,
        pCO2=pCO2)
      ...
      replaceable FiggeFencl.FiggeFenclNSID normalPlasma(
        pH0=7.4,
        pCO20=40,
        alb0=alb,
    ...
    package comparisson
      ...
      package Auxiliary
        ...
        model ResultSetAtBE
          ...
          FullBloodAcidBase.Full_Blood.comparisson.Auxiliary.SetAtAlb LowAlb(
            BE=BE,
            pCO2=pCO2,
            alb=alb/2,
            Hb=Hb,
          ...
          FullBloodAcidBase.Full_Blood.comparisson.Auxiliary.SetAtAlb Normal(
            BE=BE,
            pCO2=pCO2,
            alb=alb,
            Hb=Hb,
          ...
          FullBloodAcidBase.Full_Blood.comparisson.Auxiliary.SetAtAlb HighAlb(
            BE=BE,
            pCO2=pCO2,
            alb=alb*2,
            Hb=Hb,
        ...
        model SetAtAlb
          ...
          SAnomogram_formalization.SAoriginal normalBloodSA(
            ...
            pCO2=pCO2) "SA original for comparison only"
            annotation (Placement(transformation(extent={{60,20},{80,40}})));
          FullBloodAcidBase.SAnomogram_formalization.SAVanSlyke sAVanSlyke(
            pCO2=pCO2,
            BEox=BE,
            Hct=Hb/33.34,
            sO2=1,
          ...
          Full_Blood.Wolf_full_blood wolf_full_blood(
            pCO2=pCO2,
            BE=BE,
    ...
    model Wolf_full_blood
      ...
      Real Qp=(C_NaP + C_KP + 2*C_CaP + 2*C_MgP - C_ClP - HCO3P - 2*CO3P + ZPi*
          C_PiP + ZAlb*C_AlbP + ZimP)*Vpw + X;
      Real Qpp[:]={C_NaP,+C_KP,+2*C_CaP,+2*C_MgP,-C_ClP,+ZPi*C_PiP,+ZAlb*C_AlbP,
          +ZimP};
    ...
    model CombinedModelSimple
      ...
      SAnomogram_formalization.Zander1995 fullErythrocyte(
        Hct=1,
        BEox=BEe,
        pCO2=pCO2)
        annotation (Placement(transformation(extent={{20,20},{40,40}})));
...
*/
    ...
    model Figure_2
      ...
      FullBloodAcidBase.Full_Blood.comparisson.Auxiliary.SetAtAlb fixedBE(
        BE=BEfixed,
        pCO2=pCO2,
        alb=alb,
        Hb=Hb,
        Pi=Pi) "Normal model set at fixed BE";
      FullBloodAcidBase.Full_Blood.comparisson.Auxiliary.SetAtAlb fixedpCO2(
        BE=BE,
        pCO2=pCO2fixed,
        alb=alb,
        Hb=Hb,
...
*/
    ...
    model Figure_5 "Effects of acute hypoalbuminemia"
      ...
      FullBloodAcidBase.Full_Blood.comparisson.Auxiliary.SetAtAlb fixedSID(
        BE=BEsidf,
        pCO2=pCO2,
        alb=alb,
        Hb=Hb,
...
*/
    ...
    model Supplement_Figure1 "Comparison of SA nomogram formalisations"
      ...
      SAnomogram_formalization.SA_comparison_pCO2 sA_comparison_pCO2_BE_10(
        BEox=-15,
        pCO2=pCO2,
        Hct=Hct)
        annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
      SAnomogram_formalization.SA_comparison_pCO2 sA_comparison_pCO2_BE0(
        BEox=0,
        pCO2=pCO2,
        Hct=Hct)
        annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
      SAnomogram_formalization.SA_comparison_pCO2 sA_comparison_pCO2_BE10(
        BEox=15,
        pCO2=pCO2,
