...
<pre><font style=\"color: #006400; \">Filip Jezek, 2016</font></pre>
  ...
  package FullBloodEmpirical
    ...
    model Zander1995 "Implementation according to [Zander, 1995]"
      extends Auxiliary.FullBloodEmpiricalBase;
      Real BE=(1 - 0.0143*Hb)*((0.0304*pCO2*(10^(pH - 6.1)) - 24.26) + (9.5 + 1.63
          *Hb)*(pH - 7.4)) - 0.2*Hb*(1 - sO2);
    equation 
    ...
    model Kofr2009 "[Kofranek, 2009]"
      ...
      Real a[:]={996.35 - 10.35*Hb,35.16875 + 0.25875*Hb,-82.41 + 2.01*Hb,-5.27625
           - (5.025e-2)*Hb,121 - Hb,2.625 + 0.025*Hb,-2.556 - 0.0944*Hb,13.87634
           + 0.186653*Hb + 0.00534936*Hb^2,0.548 - 0.0274*Hb,0.274 - 0.0137*Hb};
    ...
    protected 
      ...
      constant Real pco2BECoef[:]={8.3975e-009,-513.9503e-009,3.8105e-006,231.6888e-006,
          -46.5581e-003,353.7105e-003,39.9871e+000};
      constant Real pHBBCoef[:]={40.8936e-012,-13.0063e-009,1.6780e-006,-111.7919e-006,
          4.0776e-003,-67.8274e-003,7.2888e+000};
      constant Real pHBECoef[:]={131.3315e-009,2.5027e-006,175.6144e-006,11.9273e-003,
          7.4001e+000};
    public 
...
*/
    ...
    model Supplement_Figure1 
      "Comparison of SA nomogram formalisations"
      extends Modelica.Icons.Example;
      Real pCO2=time*60 + 20;
      parameter Real Hb=15;
...
<p><span style=\"font-family: Arial,sans-serif; color: #222222; background-color: #ffffff;\">SIGGAARD‐ANDERSEN, M. A. D. S., and Ole SIGGAARD‐ANDERSEN. &quot;Oxygen status algorithm, version 3, with some applications.&quot;&nbsp;<i>Acta Anaesthesiologica Scandinavica</i>&nbsp;39.s107 (1995): 13-20.</span></p>
    ...
    model FullBlood
      ...
      Physiolibrary.Types.RealIO.VolumeInput volume if UseVolInput 
        "total compartment volume" annotation (Placement(transformation(extent={
                {60,60},{100,100}}), iconTransformation(extent={{60,60},{100,100}})));
    ...
    equation 
      ...
      connect(ctO2content.sO2, ctCO2content.sO2) annotation (Line(points={{72,38},
              {72,28},{24,28},{24,-16},{38,-16}}, color={0,0,127}));
      ...
      connect(ctO2content.FMetHb, fMetHb.y) annotation (Line(points={{82,60},{84,
              60},{84,59},{85.875,59}}, color={0,0,127}));
  ...
  package OriginalValues
    package Auxiliary
      ...
      record Plasma
        ...
        //   parameter Real Zim ;//= -5.3 "Charge of ALL impermeable solutes";//test
        // Real Zim = -5.3 "Charge of ALL impermeable solutes";//test
        parameter Real Zim=-10.99 "ADJUSTED Charge of ALL impermeable solutes";
        //test
  ...
  package v349
    package Auxiliary
      record Erythrocyte
        ...
        Real charge=(sum(water_c .* Z) - HCO3 - 2*CO3 - Lactate + Zim*Vew0/Vew)*
            Vew;
      ...
      record Plasma
        ...
        Real SID=sum(water_c[{cont.Na,cont.K}]) - water_c[cont.Cl] + 2*sum(
            water_c[{cont.Ca,cont.Mg}]) - CaPPBound - MgPPBound - water_c[cont.Lac];
        Real charge=Zim + SID + water_c[cont.Alb]*ZAlb + water_c[cont.Pi]*ZPi -
            HCO3 - 2*CO3 - SO4pw*2;
        //*water_volume;
      ...
      record Volumes
        ...
        parameter Real TBWm=2.447 - 0.09156*age + 0.3362*weight + 0.1074*height;
        //Real TBWf
        ...
        parameter Real TBW=2.447 - 0.09156*age + 0.3362*weight + 0.1074*height 
          "Woodrow 2003 for male, there also exists female variant";
    ...
    package Tests
      ...
      model I
        FullBloodAcidBase.Wolf.v349.Auxiliary.Isf isf(permeableParticles=10.62755);
        FullBloodAcidBase.Wolf.v349.Auxiliary.Volumes vols;
